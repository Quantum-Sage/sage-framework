...
plt.savefig('/home/claude/netsquid_benchmark_iit.png', dpi=150, 
            facecolor=C_BG, bbox_inches='tight')
print("\n✓ Saved: netsquid_benchmark_iit.png")

# Export all benchmark data
df_homogeneous.to_csv('/home/claude/benchmark_homogeneous.csv', index=False)
df_handover.to_csv('/home/claude/benchmark_handover.csv', index=False)
...
phase_df.to_csv('/home/claude/iit_phase_diagram.csv', index=False)
...
with open('/home/claude/netsquid_config.json', 'w') as f:
