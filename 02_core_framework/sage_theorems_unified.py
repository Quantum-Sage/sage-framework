...
# ============================================================================
# CONSTANTS (shared across all theorems)
# ============================================================================
...
def n_w_star_uniform(N, L, hw_w, hw_q, S=SAGE_CONSTANT):
    ...
    if a_w <= a_q:
        return N  # Willow not better → need all Willow
    ln_S = math.log(S)
...
def validate_all_theorems(L=ROUTE_BEIJING_LONDON, N_values=None):
    """
...
def theorem_comparison_data(L=ROUTE_BEIJING_LONDON):
    """
...
if __name__ == '__main__':
    ...
    above_sage = sum(1 for f in comp["stoch_fidelities"] if f >= SAGE_CONSTANT)
    print(f'  {above_sage}/{len(comp["N_range"])} configurations meet Sage Constant'
