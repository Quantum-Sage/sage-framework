...
## Email D1: arXiv Endorsement Request (Dr. Stephanie Wehner)

**To:** `S.D.C.Wehner@tudelft.nl`
**Subject:** c
...
A key result of this paper is proving that the geometric retry distribution of probabilistic entanglement generation introduces a strict $(1 + 2/p)$ degradation penalty. For current hardware architectures, this reveals a precise analytical bound on the maximum feasible end-to-end fidelity limit over intercontinental distances. The results have been validated against QuTiP density-matrix simulations.
...
Given your leadership at QuTech, the Quantum Internet Alliance, and your foundational work on entanglement routing protocols, I believe this analytical bounding method will be highly relevant to your ongoing network topology research. 
...
## Email D2: arXiv Endorsement Request (Dr. Mikhail Lukin)

**To:** `lukin@physics.harvard.edu`
...
Given your lab's leading work on scalable solid-state quantum memory, silicon-vacancy (SiV) centers in diamond, and atom arrays, I believe this analytical bound on sequential fidelity decay will be highly relevant to your ongoing hardware topology research. 
...
## Email D3: arXiv Endorsement Request (Dr. Dirk Englund)
...
Given your group's leading work on photonic integrated circuits and highly scalable modular quantum networking architectures, I believe this analytical bounding method will be highly relevant to your ongoing hardware topology research. 
